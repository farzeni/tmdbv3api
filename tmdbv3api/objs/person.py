...
class Person(TMDb):
    ...
    def details(self, person_id, append_to_response='videos,images'):
        ...
        :return:
        """
        return self._call(self._urls['details'] % str(person_id), 'append_to_response=' + append_to_response)
    ...
    def images(self, person_id):
        ...
        :return:
        """
        return self._call(self._urls['images'] % str(person_id), '')
    ...
    def search(self, term, page=1):
        ...
        :return:
        """
        return self._call(self._urls['search_people'], 'query=' + quote(term) + '&page=' + str(page))
